                    ...
                    <div className="flex w-full flex-col gap-8 p-5 md:p-10">
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                                <div className="flex gap-3">
                                    ...
                                    <p className="p-medium-16 rounded-full bg-grey-500/30 px-4 py-2.5 text-grey-600">
                                        {event.category.name}
                                    </p>
                                </div>
                        ...
                        <div className="flex flex-col gap-5">
                            <div className="flex gap-2 md:gap-3">
                                ...
                                <div className="p-medium-16 lg:p-regular-20 flex flex-col flex-wrapp items-center">
                                    <p>
                                        From: {formatDateTime(event.startDateTime).dateOnly} - {formatDateTime(event.startDateTime).timeOnly}
                                    </p>
                                    <p>
                                        Until: {formatDateTime(event.endDateTime).dateOnly} - {formatDateTime(event.endDateTime).timeOnly}
                                    </p>
                                </div>
                            </div>
